  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <main className="flex-grow">
        ...
        {/* Additional content sections for later */}
          ...
          <div className="max-w-screen-xl px-4 mx-auto lg:px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                Our platform is designed to streamline your bug tracking process and improve team collaboration.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-sm">
                ...
                <p className="text-gray-600 dark:text-gray-300">Enterprise-grade security to keep your data safe and accessible only to your team.</p>
              </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-sm">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Fast & Efficient</h3>
                <p className="text-gray-600 dark:text-gray-300">Optimized performance to ensure your team can track and resolve issues quickly.</p>
              </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-sm">
                ...
                <p className="text-gray-600 dark:text-gray-300">Built-in tools to help your team communicate and work together effectively.</p>
              </div>
            </div>
          </div>
        </section>
